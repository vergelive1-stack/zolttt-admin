...
import { getBroadcastGame, deleteBroadcastGame, handleVIPSwitchBroadcastGame } from '../../store/BroadcastGame/action'
...
const BroadcastGameTable = (props) => {
  ...
  const broadcastgame = useSelector(state => state.broadcastgame.broadcastgame)
  console.log('broadcastgame: ', broadcastgame);
...
export default connect(null, { getBroadcastGame, deleteBroadcastGame })(BroadcastGameTable)
